...
export const FilterBar = () => {
  const { active, hadleCheckbox } = useContext(PokemonContext);
  ...
  return (
    <div className={`container-filters ${active ? 'active' : ''} `}>
      <div className='filter-by-type'>
        ...
        <div className='group-type'>
          <input type='checkbox' onChange={hadleCheckbox} name='bug' id='bug' />
        ...
        <div className='group-type'>
          <input type='checkbox' onChange={hadleCheckbox} name='ice' id='ice' />
